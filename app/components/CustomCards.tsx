...
const AnimatedCard = ({ title, description, icon }: CardProps) => {
  ...
  return (
    <motion.div
      ...
      className="relative rounded-2xl overflow-hidden bg-gradient-to-br from-[#F54180] via-[#C20E4D] to-[#920B3A] p-8 text-white shadow-lg"
    >
